...
function conditionImage(data) {
    const containerEl = document.querySelector(".city-container");
    ...
    <div class="city-container">
        <div class="city-mainbox">
            ...
            <div class="create-city">
                ...
                <h1 class="create-city__temp" >${formattemperature(weatherData.current.temp_c)}°</h1>
                <p class="create-city__condition">${weatherData.current.condition.text}</p>
                <div class="create-city__temperature">
                    <span>H:${weatherData.forecast.forecastday[0].day.maxtemp_c}°</span>
                    <span>T:${weatherData.forecast.forecastday[0].day.mintemp_c}°</span>
                </div>
            </div>
            <div class="forecast-box">
            <div class="forecast-box__today">
                <p class="forecast-box__text">Heute ${weatherData.forecast.forecastday[0].day.condition.text}.</p>
                <p class="forecast-box__text">Wind bis zum ${weatherData.forecast.forecastday[0].day.maxwind_kph}km/h.</p>
            </div>
    ...
    forecastDayEl.innerHTML += `
      <div class="weather-footer">
          <div class="weather-footer__left">
            ...
            <span class="weather-footer__left-info">${dayInfo.current.humidity
        }%</span>
          </div>
          <div class="weather-footer__right">
            <p class="weather-footer__right-text">Gefühlt</p>
            <span class="weather-footer__right-info">${dayInfo.current.feelslike_c
        }°</span>
          </div>
      </div>
      <div class="weather-footer">
      ...
      <div class="weather-footer">
          <div class="weather-footer__left">
            ...
            <span class="weather-footer__left-info">${dayInfo.current.precip_mm
        }mm</span>
          </div>
          <div class="weather-footer__right">
            <p class="weather-footer__right-text">UV-Index</p>
            <span class="weather-footer__right-info">${dayInfo.current.uv
        }</span>
          </div>
      </div>
  `;
